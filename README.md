...
The latest major version is: `v0`, which is the most recommended to use. (You can also use the latest full version: `v0.0.2`)  
...
We use Qemu and Libvirt to run the OpenIndiana VM.
