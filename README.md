# Run GitHub CI in OpenIndiana 

![Test](https://github.com/vmactions/openindiana-vm/workflows/Test/badge.svg)
...
>
> Just describe what you want in plain language, e.g. *"run my tests on OpenIndiana"* or *"check that my project builds on OpenIndiana aarch64"*, and the agent generates a correct, ready-to-commit `test.yml`. It will:
>
...
Use this action to run your CI in OpenIndiana.

The github workflow only supports Ubuntu, Windows and MacOS. But what if you need to use OpenIndiana?
...
We use Qemu to run the OpenIndiana VM.
